...
public class AnimationImageView extends ImageView {
    ...
    public void initFocus() {
        ...
        new Thread(new SleepThread(mMainHandler, CameraActivity.FOCUS_DISAPPEAR, 1000, null)).start();
    }
    ...
    public void startFocusing() {
        ...
        this.setBackground(mContext.getDrawable(R.mipmap.focus));
        new Thread(new SleepThread(mMainHandler, CameraActivity.FOCUS_DISAPPEAR, 1000, Integer.valueOf(mTimes))).start();
    }

    public void focusFailed() {
        mTimes++;
        this.setBackground(mContext.getDrawable(R.mipmap.focus_failed));
